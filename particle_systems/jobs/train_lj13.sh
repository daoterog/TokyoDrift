...
CONFIG="$REPOSITORY_ROOT/particle_systems/configs/lj13/gaussian.json"
TRAIN_DIRECTORY="$REPOSITORY_ROOT/models/lj13/runs/$RUN_ID"
FINAL_CHECKPOINT="$REPOSITORY_ROOT/models/lj13/gaussian-$RUN_ID.pt"

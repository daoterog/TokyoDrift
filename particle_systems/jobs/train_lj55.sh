...
#SBATCH --gpus=1
#SBATCH --job-name=train-lj55
#SBATCH --output=train-lj55-%j.out
#SBATCH --time=3:00:00
#SBATCH --ntasks=1
...
CONFIG="$REPOSITORY_ROOT/particle_systems/configs/lj55/gaussian.json"
TRAIN_DIRECTORY="$REPOSITORY_ROOT/models/lj55/runs/$RUN_ID"
FINAL_CHECKPOINT="$REPOSITORY_ROOT/models/lj55/gaussian-$RUN_ID.pt"

...
class DeviceSelectionTests(unittest.TestCase):
    ...
    @patch("particle_systems.io.torch.cuda.is_available", return_value=False)
    ...
    @patch("particle_systems.io.torch.cuda.is_available", return_value=True)
    def test_auto_prefers_cuda(self, _mock: object) -> None:
        self.assertEqual(select_device("auto"), torch.device("cuda"))

    @patch("particle_systems.io._mps_available", return_value=True)
    @patch("particle_systems.io.torch.cuda.is_available", return_value=False)

...
from particle_systems.alanine import (
    PHI,
    PSI,
    AlanineDrift,
    backbone_angles,
...
from particle_systems.alanine_metrics import (
    exact_wasserstein_1,
    probability_metrics,
    torsion_comparison,
)
from particle_systems.evaluate_alanine import energy_report
from particle_systems.evaluate_alanine import main as evaluate_main
from particle_systems.io import build_model
from particle_systems.train import main as train_main
...
class AlanineTests(unittest.TestCase):
    ...
    def test_energy_report_preserves_nonfinite_and_tail_failures(self) -> None:
        ...
        self.assertLess(
            report["generated_geometry_chirality_and_energy_valid_fraction"], 1
        )
    ...
    def test_training_uses_official_validation_split_and_writes_best_checkpoint(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with (
                patch("particle_systems.train.load_dataset", side_effect=load),
            ...
            with (
                patch(
                    "particle_systems.evaluate_alanine.load_dataset",

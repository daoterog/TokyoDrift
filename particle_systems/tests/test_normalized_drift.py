...
from particle_systems.descriptors import DescriptorDrift, particle_descriptors
from particle_systems.train import main as train_main
from particle_systems.train import resolve_drift_definition
from particle_systems.unnormalized_drifting import DirectCoordinateDrift
...
class NormalizedDriftTests(unittest.TestCase):
    ...
    def test_lj55_training_override_checkpoint_and_resume(self):
        config_path = Path(__file__).resolve().parents[1] / "configs/lj55/gaussian.json"
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with (
                patch(
                    "particle_systems.train.load_dataset",

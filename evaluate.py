...
from data.systems import center, get_system, pair_distances
from utils.io import build_model, device_summary, load_dataset, select_device
from utils.kde import descriptor_kde_nll, raw_distance_kde_report
...
def main() -> None:
    ...
    if system.name == "aldp":
        raise ValueError("use python -m evaluate_alanine for molecular metrics")
